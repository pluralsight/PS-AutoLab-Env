...
Goal - Domain Controller (DC), Populute with OU's Groups and Users.
	   File server (FILE1)
	   SQL Server (SQL1)
	   Web Server (WEB1)
       One Windows 10 CLient joined to the new domain (CLIENT1)
...
@{
    AllNodes = @(
        @{
            ...
            Lability_SwitchName = 'windows-server-2016-core-networking'
